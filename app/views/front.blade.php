...
<script type="text/javascript">
    ...
    _tmr.push({id: "2751852", type: "pageView", start: (new Date()).getTime()});
    (function (d, w, id) {
        ...
        <img src="//top-fwz1.mail.ru/counter?id=2751852;js=na" style="border:0;" height="1" width="1" alt="Рейтинг@Mail.ru" />
    </div></noscript>
<!-- //Rating@Mail.ru counter -->
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav cl-effect-1">
                        ...
                        <li><a href="/"><span class="glyphicon glyphicon-plus"></span> Медицинский туризм</a></li>
                    </ul>
                </div><!--/.nav-collapse -->
            </div><!--/.container-fluid -->
        </div>
...
<div class="container">
    <div class="content row">
        @section('content')
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 margintop20 marginbottom">
...
<script type="text/javascript">
    /* <![CDATA[ */
    var google_conversion_id = 928239510;
    var google_custom_params = window.google_tag_params;
    var google_remarketing_only = true;
    /* ]]> */
</script>
...
<noscript>
    <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/928239510/?value=0&amp;guid=ON&amp;script=0"/>
    </div>
</noscript>
</body>
