        ...
        @foreach ( $users as $key => $user)
            <tr>
                ...
                <td class="gradeA">
                    ...
                    <a href='{{ URL::route("user/delete", array($user->id)) }}' class="btn btn-danger" onclick="return confirm('Вы действительно хотите удалить объект?')"><i class="fa fa-trash-o fa-fw"></i></a>
                </td>
            </tr>
        @endforeach
    </tbody>
